...
3) EndpointSlice is a Kubernetes resource that stores the actual IP addresses of the Pods that belong to a Service. This is how we can connect a Service to the Pods and list all of their IP's that the service can connect to. The service ClusterIP and EndpointSlice
